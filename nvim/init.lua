...
vim.keymap.set('n', '<leader>tc', '<cmd>ClangdSwitchSourceHeader<CR>')
...
require('lazy').setup({
...

  {
    ...
    config = function()
      -- You can leave this empty or add specific setup here
    end,
  },
  ...
  { -- Fuzzy Finder (files, lsp, etc)
    ...
    config = function()
      ...
      vim.keymap.set('n', '<F5>', ':w<CR>:!gcc % -o %:r && ./%:r<CR>', { desc = 'Build and Run C' })
